    ...
    $('#generateButton').click(function () {
        try {
            ...
            let contestDetailsHtml = `
                ...
                <div class="flex-fill text-white"><span class="fw-bold">Number of Participants: </span>${names.length}</div>
                <div class="flex-fill text-white"><span class="fw-bold">Contest: </span>${contestName}</div>
                <div class="flex-fill text-white"><span class="fw-bold">Date: </span>${currentDate}</div>
                </div>
            `;
            if (sponsored) {
                contestDetailsHtml += `<div class="flex-fill text-white"><span class="fw-bold">Sponsored by:  </span>${sponsorName}</div>`;
            }
